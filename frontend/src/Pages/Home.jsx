...
// Typing effect and tech stack constants
const TYPING_SPEED = 100;
const ERASING_SPEED = 50;
const PAUSE_DURATION = 2000;
const WORDS = ["Building MERN Applications", "Experience in Java & SpringBoot", "Creating RESTful APIs", "Problem Solving & DSA Enthusiast"];
...
const SOCIAL_LINKS = [
	{ icon: Github, link: "https://github.com/MohitWadhwani" },
	{ icon: Linkedin, link: "https://www.linkedin.com/in/mohitwadhwani/" },
	{
		icon: Mail,
		link: "https://mail.google.com/mail/?view=cm&fs=1&to=mohit.wadhwani2.01@gmail.com",
		isMail: true,
	},
];
...
const Home = () => {
	...
	const lottieClassName = `w-full h-full transition-all duration-500 ${
		isHovering
						...
						>
							<div className="space-y-4 sm:space-y-6">
								...
								<p
									...
									data-aos-delay="1000"
								>
									Motivated full-stack developer with experience in MERN stack and
									Java. Skilled in building modern web applications, RESTful APIs, and
