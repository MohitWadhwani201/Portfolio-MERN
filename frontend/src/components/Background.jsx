    ...
    <div className="fixed inset-0">
      <div className="absolute inset-0">
        ...
        <div
          ...
          className="absolute top-0 -left-4 md:w-96 md:h-96 w-72 h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 md:opacity-25"
        ></div>
        {/* Cyan blob */}
        <div
        ...
        <div
          ...
          className="absolute -bottom-8 left-[-40%] md:left-20 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-35 md:opacity-20"
        ></div>
        {/* Blue blob right */}
        <div
